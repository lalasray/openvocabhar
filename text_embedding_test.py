...
embeddings = model.encode(["A person is running.","A person is walking.", "A person is eating.", "A person in walking while eating."], convert_to_tensor=True,).to(device)
text = vec2text.invert_embeddings(embeddings=embeddings,corrector=corrector,num_steps=20,)
#print(text[0])
